...
// 책 추가
exports.addBook = 'insert into book(book_name, book_amount, book_price) values(?, ?, ?)';

// 책 수정
exports.updateBook = 'update book set book_name=?, book_amount=?, book_price=?, book_explain=? where book_number=?';
